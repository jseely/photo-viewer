...
var _Object$defineProperty = __webpack_require__(120)["default"];
...
var _Object$create = __webpack_require__(119)["default"];

var _Object$setPrototypeOf = __webpack_require__(123)["default"];
...
var _inlineStylePrefixer = __webpack_require__(147);
...
if (typeof window === 'undefined' || typeof navigator === 'undefined' || navigator.userAgent.indexOf("Node.js") !== -1 || navigator.userAgent.indexOf("jsdom") !== -1) {
  ...
  module.exports = g.Velocity ? g.Velocity : __webpack_require__(214);
...
var _isPrefixedProperty = __webpack_require__(171);
...
var _mergeStyles = __webpack_require__(184);

var _plugins = __webpack_require__(72);

var _plugins2 = _interopRequireDefault(_plugins);

var _exenv = __webpack_require__(146);
...
var _radium = __webpack_require__(182);

var _radium2 = _interopRequireDefault(_radium);

var _velocityReact = __webpack_require__(82);
...
module.exports = {
  VelocityComponent: __webpack_require__(262),
  VelocityTransitionGroup: __webpack_require__(264),
  velocityHelpers: __webpack_require__(263),
};
...
var arrayMap = __webpack_require__(84),
    baseDifference = __webpack_require__(227),
...
var Gallery_1 = __webpack_require__(99);
var react_treebeard_1 = __webpack_require__(195);
var App = (function (_super) {
    ...
    App.prototype.onToggle = function () { };
    App.prototype.render = function () {
        return React.createElement("main", null,
            React.createElement("nav", null,
                React.createElement(react_treebeard_1.Treebeard, { data: this.state.data, onToggle: this.onToggle, decorators: react_treebeard_1.decorators })),
            React.createElement("section", null,
                React.createElement(Gallery_1.Gallery, { path: this.state.galleryPath })));
    };
    return App;
}(React.Component));
exports.App = App;
...
var File = (function () {
    ...
    File.prototype.src = function () {
        return this.props.src;
    };
    File.prototype.size = function () {
        return this.props.imgSize;
    };
    File.prototype.render = function (maxSize) {
        var renderSize;
        ...
        if (this.isDir()) {
            return React.createElement("img", { src: this.props.img, height: renderSize.height, width: renderSize.width, alt: this.props.src });
        }
        else {
            return React.createElement("a", { href: this.props.img, "data-lightbox": "images", "data-title": this.props.src },
                React.createElement("img", { src: this.props.img, height: renderSize.height, width: renderSize.width, alt: this.props.src }));
        }
    };
    File.prototype._scaleImage = function (imgSize, maxSize) {
        var hScale = maxSize.height / imgSize.height;
        var wScale = maxSize.width / imgSize.width;
        if (hScale > wScale) {
...
var axios_1 = __webpack_require__(101);
var File_1 = __webpack_require__(98);
var Gallery = (function (_super) {
    ...
    Gallery.prototype.componentDidMount = function () {
        var _this = this;
        this.setState(__assign({}, this.state, { containerWidth: Math.floor(ReactDOM.findDOMNode(this).getBoundingClientRect().width) }));
        axios_1.default.get("" + window.location.origin + this.state.path)
            .then(function (res) {
            var files = [];
            res.data.forEach(function (f, i) { return files.push(new File_1.File(f)); });
            _this.setState(__assign({}, _this.state, { files: files }));
        });
    ...
    Gallery.prototype.componentDidUpdate = function () {
        ...
        if (clientWidth !== this.state.containerWidth) {
            this.setState(__assign({}, this.state, { containerWidth: Math.floor(clientWidth) }));
        }
    };
    ...
    Gallery.prototype.render = function () {
        ...
        var maxImgSize = { width: this.state.containerWidth / this.props.cols, height: 99999999 };
        ...
        this.state.files.forEach(function (file, index) {
            ...
            photoPreviewNodes.push(React.createElement("div", { key: index, style: style, height: maxHeight },
                React.createElement("a", { href: "#", onClick: function (e) { return _this.props.onClickPhoto(_this.state.files[index], _this); } }, _this.state.files[index].render(maxImgSize))));
        });
...
Gallery.defaultProps = {
    cols: 3,
    onClickPhoto: function (file, g) {
        var _this = this;
        if (file.isDir()) {
            axios_1.default.get("" + window.location.origin + file.src())
                .then(function (res) {
                var files = [];
                res.data.forEach(function (f, i) { return files.push(new File_1.File(f)); });
                g.setState(__assign({}, _this.state, { path: file.src(), files: files }));
            });
        }
    },
    margin: 2
...
ReactDOM.render(React.createElement(App_1.App, null), document.getElementById("application"));
...
!function (root, name, definition) {
  ...
  else if (true) __webpack_require__(269)(name, definition)
...
var _prefixAll2 = __webpack_require__(168);
...
var _prefixProps = __webpack_require__(158);

var _prefixProps2 = _interopRequireDefault(_prefixProps);

var _position = __webpack_require__(154);

var _position2 = _interopRequireDefault(_position);

var _calc = __webpack_require__(148);

var _calc2 = _interopRequireDefault(_calc);

var _zoomCursor = __webpack_require__(157);

var _zoomCursor2 = _interopRequireDefault(_zoomCursor);

var _grabCursor = __webpack_require__(152);
...
var _sizing = __webpack_require__(155);
...
var _unprefixProperty = __webpack_require__(172);
...
var _calc = __webpack_require__(159);

var _calc2 = _interopRequireDefault(_calc);

var _cursor = __webpack_require__(160);
...
var _flexboxIE = __webpack_require__(162);
...
var _keyframes = __webpack_require__(183);
...
var _mouseUpListener = __webpack_require__(188);
...
var _Object$keys = __webpack_require__(122)['default'];
...
var _themesDefault = __webpack_require__(76);

var _themesDefault2 = _interopRequireDefault(_themesDefault);

var _themesAnimations = __webpack_require__(75);
...
module.exports = {
    Treebeard: __webpack_require__(198),
    decorators: __webpack_require__(74),
    animations: __webpack_require__(75),
    theme: __webpack_require__(76)
};
...
var arrayMap = __webpack_require__(84),
    baseCallback = __webpack_require__(225),
...
/* WEBPACK VAR INJECTION */(function(global) {var cachePush = __webpack_require__(241),
    getNative = __webpack_require__(29);
...
/* WEBPACK VAR INJECTION */(function(global) {var SetCache = __webpack_require__(219),
    getNative = __webpack_require__(29);
...
var assignWith = __webpack_require__(223),
...
var _ = {
  ...
  isEqual: __webpack_require__(93),
  keys: __webpack_require__(11),
  omit: __webpack_require__(94),
};
var React = __webpack_require__(1);
var ReactDOM = __webpack_require__(20);
var Velocity = __webpack_require__(45);
...
var _ = {
  ...
  extend: __webpack_require__(260),
  forEach: __webpack_require__(46),
  isEqual: __webpack_require__(93),
  keys: __webpack_require__(11),
  omit: __webpack_require__(94),
  pluck: __webpack_require__(218),
};
var React = __webpack_require__(1);
var ReactDOM = __webpack_require__(20);
